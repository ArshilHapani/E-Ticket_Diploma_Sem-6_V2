...
router.patch("/", async (req, res) => {
  const { p_id, p_uname, p_name, p_email, p_no } = req.body;
  let success = false;
  ...
  const setPassenger = `UPDATE passenger SET p_uname='${p_uname}', p_name='${p_name}', p_email='${p_email}', p_no=${p_no ? p_no : null} WHERE p_id='${p_id}'`;
